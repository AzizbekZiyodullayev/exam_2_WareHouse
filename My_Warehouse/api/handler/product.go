...
func (h *handler) CreateProduct(c *gin.Context) {
	...
	id, err := h.storage.Product().Create(c.Request.Context(), &createProduct)
	if err != nil {
		h.handlerResponse(c, "storage.product.create", http.StatusInternalServerError, err.Error())
		return
	}

	resp, err := h.storage.Product().GetByID(c.Request.Context(), &models.ProductPrimaryKey{Id: id})
	if err != nil {
...
func (h *handler) UpdateProduct(c *gin.Context) {
	...
	updateProduct.Id = id
	rowsAffected, err := h.storage.Product().Update(c.Request.Context(), &updateProduct)
	if err != nil {
	...
	resp, err := h.storage.Product().GetByID(c.Request.Context(), &models.ProductPrimaryKey{Id: updateProduct.Id})
	if err != nil {
		h.handlerResponse(c, "storage.product.getById", http.StatusInternalServerError, err.Error())
		return
	}

...
func (r *remainderRepo) Create(ctx context.Context, req *models.CreateRemainder) (string, error) {
	...
	query = `
		INSERT INTO remainder(id, branch_id, category_id, name, barcode, amount, price,total_price, updated_at)
		VALUES ($1, $2, $3, $4, $5, $6, s$7, $8, NOW())
	`
...
func (r *remainderRepo) GetList(ctx context.Context, req *models.RemainderGetListRequest) (*models.RemainderGetListResponse, error) {
	...
	if req.SearchByBranch != "" {
		where += ` AND filial_id ILIKE '%' || '` + req.SearchByBranch + `' || '%'`
	}
...
func (r *remainderRepo) DoIncomeWareHouse(ctx context.Context, req *models.RespProduct) (int64, error) {
	trx, err := r.db.Begin(ctx)
	if err != nil {
		return 0, nil
	}
